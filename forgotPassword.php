...
style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">TMSTourism Management System</h1>
</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
...
<p style="width: 350px;">
<b>Email id</b> <input type="email" name="email" class="formcontrol" id="email" placeholder="Reg Email id" required="">
</p>
<p style="width: 350px;">
<b>Mobile No</b> <input type="text" name="mobile" class="formcontrol" id="mobile" placeholder="Reg Mobile no" required="">
</p>
<p style="width: 350px;">
<b>New Password</b>
